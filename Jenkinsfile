...
properties([
	parameters([
        string(defaultValue: "master", description: 'Which sdfsdas sdfsdasvf Git Branch to clone?', name: 'GIT_BRANCH'),
        ...
        string(defaultValue: "java-app", description: 'AWS ECR Repository where buiasdasdsdvlt docker images will be pushed.', name: 'ECR_REPO_NAME')
	])
])
try {
